...
```bash
curl -s "http://139.9.42.203:8988/api.json" -o api_spec.json
```
...
ApiClient({this.basePath = 'http://139.9.42.203:8988', ...});
...
| 操作 | 命令 |
|------|------|
| 更新 API 文档 | `curl -s "http://139.9.42.203:8988/api.json" -o api_spec.json` |
